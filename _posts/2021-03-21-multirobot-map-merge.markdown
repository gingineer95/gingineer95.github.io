...
<div align="center">Frontier edges are open cells adjacent to unknown cells, marked with an “x” below. 
![]({{ site.baseurl }}/images/frontier_edges.png)</div>
...
![]({{ site.baseurl }}/images/frontier_regions.png)</div>

Below is a video of frontier exploration working on one robot both in simulation and on an actual Turtlebot3
** insert video **

## Map Expansion
Before being able to merge the robot's maps, I had to manipulate the maps generated by slam_toolbox. The multirobot_map_merge node that I used was originally written for gmapping and in this node
